...
export default function Feed() {
  const data = [
    ...
    },
    {
      ...
      verified: false,
      postAuthorURL:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdYTc5ImnPAvw4FAu2o7YLdaxfn1RZsz4Z0g&s",
    },
  ];
  ...
  return (
    <FeedContainer>
      ...
      <ContactsSticky>
        ...
        <SidebarButton>
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdYTc5ImnPAvw4FAu2o7YLdaxfn1RZsz4Z0g&s"
            alt="profile"
            style={{
              width: 30,
              height: 30,
